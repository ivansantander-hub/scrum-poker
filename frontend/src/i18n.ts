...
export const translations = {
  en: {
    ...
    noRoomsYet: 'You have not created any rooms yet.',
    noJoinedRoomsYet: 'You have not joined any rooms yet.',
  ...
  es: {
    ...
    noRoomsYet: 'Aún no has creado ninguna sala.',
    noJoinedRoomsYet: 'Aún no te has unido a ninguna sala.',
    adminPanel: 'Panel Admin',
    allUsers: 'Todos los Usuarios',
    allRooms: 'Todas las Salas',
    deleteRoom: 'Eliminar',
    confirmDeleteRoom: '¿Estás seguro de que quieres eliminar esta sala?',
    role: 'Rol',
    createdAt: 'Creado',
    owner: 'Propietario',
